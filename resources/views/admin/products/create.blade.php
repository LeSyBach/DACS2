...
@section('content')
    <div class="row">
        <div class="l-12">
            <h1 class="admin-page-heading">Thêm Sản phẩm Mới</h1>

            <div class="admin-table-card">
                {{-- CẦN THIẾT: enctype="multipart/form-data" để tải ảnh --}}
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                ...
                                <textarea name="content" 
                                          ...
                                          placeholder="Nhập nội dung chi tiết về sản phẩm">{{ old('content') }}</textarea>
                            </div>
                            @error('content') 
                                <span class="input-error">
                                    <i class="fas fa-exclamation-triangle"></i> {{ $message }}
    ...
    <script>
        document.getElementById('image').addEventListener('change', function(e) {
            ...
            if (file) {
                ...
                preview.innerHTML = '<i class="fas fa-cloud-upload-alt"></i><p>Chọn ảnh để xem trước</p>';
            }
        });
    </script>
@endsection