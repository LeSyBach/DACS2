    ...
    <div class="grid wide">
        <div class="navbar">
            ...
            <div class="navbar__heading">
                <a href="<?php echo e(route('index')); ?>" class="navbar__heading-link">
...
<form class="navbar__search" id="search-form" method="GET" action="<?php echo e(route('search')); ?>">
    <input 
        type="text" 
    ...
    <div class="search-results" id="search-results" style="display: none;"></div>
            ...
            <ul class="navbar__menu">
                <li class="navbar__menu-item <?php echo e(request()->routeIs('index') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('index')); ?>" class="navbar__menu-item-link">Trang chủ</a>
                </li>
                <li class="navbar__menu-item <?php echo e(request()->routeIs('product*') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('product')); ?>" class="navbar__menu-item-link">Sản phẩm</a>
                </li>
                <li class="navbar__menu-item <?php echo e(request()->routeIs('about') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('about')); ?>" class="navbar__menu-item-link">Giới thiệu</a>
                </li>
                <li class="navbar__menu-item <?php echo e(request()->routeIs('contact') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('contact')); ?>" class="navbar__menu-item-link">Liên hệ</a>
                </li>
            </ul>
            ...
            <div class="navbar__actions">
                ...
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <div class="navbar__actions-item navbar__actions-item--logged-in">
                        <span class="navbar__user-name"><?php echo e(Auth::user()->name); ?></span>
                    ...
                    <div class="user-dropdown hidden">
                        <ul class="user-dropdown__list">
                            <li class="user-dropdown__item">
                                <a href="<?php echo e(route('profile.edit')); ?>" class="user-dropdown__link">
                                    <i class="fa-regular fa-user"></i> Trang cá nhân
                                </a>
                            </li>
                            <li class="user-dropdown__item">
                                <a href="<?php echo e(route('orders')); ?>" class="user-dropdown__link">
                ...
                <div class="navbar__actions-item navbar__actions-item--cart">
                    <?php if(isset($cartCount) && $cartCount > 0): ?>
                        <span class="navbar__cart-notice"><?php echo e($cartCount); ?></span>
                    <?php endif; ?>
                ...
                <div class="modal-cart hidden">
                    ...
                    <div class="modal-cart__body" id="cart-body-content">
                        <?php echo $__env->make('partials.cart-mini', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div> 
                </div>
            </div> 
        </div> 
...
<div class="navbar__mobile-menu" id="mobile-menu">
    ...
    <div class="navbar__mobile-header">
        <a href="<?php echo e(route('index')); ?>" class="navbar__mobile-logo">TechStore</a>
    ...
    <ul class="navbar__mobile-list">
        <li class="navbar__mobile-item <?php echo e(request()->routeIs('index') ? 'active' : ''); ?>">
            <a href="<?php echo e(route('index')); ?>" class="navbar__mobile-link">
                <i class="fa-solid fa-house"></i>
                Trang chủ
            </a>
        </li>
        <li class="navbar__mobile-item <?php echo e(request()->routeIs('product*') ? 'active' : ''); ?>">
            <a href="<?php echo e(route('product')); ?>" class="navbar__mobile-link">
                <i class="fa-solid fa-box"></i>
                Sản phẩm
            </a>
        </li>
        <li class="navbar__mobile-item <?php echo e(request()->routeIs('about') ? 'active' : ''); ?>">
            <a href="<?php echo e(route('about')); ?>" class="navbar__mobile-link">
                <i class="fa-solid fa-circle-info"></i>
                Giới thiệu
            </a>
        </li>
        <li class="navbar__mobile-item <?php echo e(request()->routeIs('contact') ? 'active' : ''); ?>">
            <a href="<?php echo e(route('contact')); ?>" class="navbar__mobile-link">
    ...
    <?php if(auth()->guard()->check()): ?>
        ...
        <div class="navbar__mobile-user">
            <div class="navbar__mobile-user-info">
                ...
                <div>
                    <div class="navbar__mobile-username"><?php echo e(Auth::user()->name); ?></div>
                    <small style="color: #666; font-size: 1.2rem;"><?php echo e(Auth::user()->email); ?></small>
                </div>
            </div>
            
            <a href="<?php echo e(route('profile.edit')); ?>" class="navbar__mobile-link">
                <i class="fa-regular fa-user"></i>
                Trang cá nhân
            </a>
            <a href="<?php echo e(route('orders')); ?>" class="navbar__mobile-link" style="border-bottom: none;">
                <i class="fa-solid fa-box"></i>
                Đơn hàng của tôi
            </a>
            
            <form action="<?php echo e(route('logout')); ?>" method="POST" style="margin-top: 15px;">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\techstore\resources\views/layouts/header.blade.php ENDPATH**/ ?>