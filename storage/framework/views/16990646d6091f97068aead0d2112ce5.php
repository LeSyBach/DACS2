...
<div class="zalopay-content payment-content-block">
    ...
    <div class="zalopay-content__total-box">
        ...
        <div class="zalopay-content__total-amount" style="color: #0070c7;"><?php echo e($grandTotalDisplay); ?></div>
    </div>
...
</div><?php /**PATH C:\xampp\htdocs\techstore\resources\views/checkout/payment_zalopay.blade.php ENDPATH**/ ?>